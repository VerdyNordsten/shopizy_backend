...
module.exports = {
	addCategory: async (req, res) => {
		try {
			...
			const categoryNameCheck = await categoryModel.categoryNameCheck(categoryName);
		...
		try {
			...
			if (search) {
				const pagination = {
					...
					dataPerPage: limitValue > dataCategory.rowCount ? dataCategory.rowCount : limitValue,
