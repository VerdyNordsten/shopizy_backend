...
const activateAccount = (link) => {
	const htmlContent = `
  <p>
    Anda menerima email ini karena Anda telah melakukan permintaan Reset Password di SHOPIZY.
    <br>
  ...
  <p>
    Jika Anda tidak merasa melakukan permintaan Reset Password di SHOPIZY, abaikan email ini.
    <br>
