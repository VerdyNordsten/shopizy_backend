...
const createValidation = [
	...
	check("recipientName", "Recipient name cannot be empty").not().isEmpty(),
	check("recipientName", "Recipient name only can contains alphabet").isAlpha("en-US", {
		ignore: " ",
	}),

	// recipient phone
	check("recipientPhone", "Recipient phone cannot be empty").not().isEmpty(),
	check("recipientPhone", "Insert a valid phone number at recipient phone").isMobilePhone(),
	...
	check("postalCode", "Postal code must be a valid post code").isPostalCode("ID"),
